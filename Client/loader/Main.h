...
#define MTA_EXE_NAME_RELEASE "meow-client.exe"

#ifdef MTA_DEBUG
    #define MTA_EXE_NAME            "meow-client_d.exe"
    #define MTA_DLL_NAME            "client_d.dll"
    #define CHECK_DM_LUA_NAME       "mods\\deathmatch\\lua5.1c_d.dll"
    #define CHECK_DM_CLIENT_NAME    "mods\\deathmatch\\Client_d.dll"
#else
    #define MTA_EXE_NAME            "meow-client.exe"
    #define MTA_DLL_NAME            "client.dll"
